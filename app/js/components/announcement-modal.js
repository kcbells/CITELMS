...
const MODAL_STYLES = `
    ...
    .ann-m-hdr { padding:22px 24px; background:#fff; border-bottom:1px solid #E5E7EB; color:#111; display:flex;
        justify-content:space-between; align-items:flex-start; gap:12px; }
    .ann-m-hdr h3 { font-size:18px; font-weight:800; margin:0 0 4px; color:#111; }
    .ann-m-hdr p { font-size:12px; margin:0; color:#6B7280; }
    .ann-m-close { background:none; border:none; color:#374151; width:32px; height:32px;
        border-radius:8px; font-size:20px; cursor:pointer; flex-shrink:0; line-height:1; }
    .ann-m-close:hover { background:#F3F4F6; }
