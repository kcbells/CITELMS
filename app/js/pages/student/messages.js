        ...
        <div class="nc-modal" style="width:440px">
            ...
            <div class="nc-body" style="padding:16px">
                <div style="margin-bottom:14px">
                    ...
                    <input id="ng-name" type="text" maxlength="80" placeholder="e.g. Study Group — CC101"
                ...
                <div>
                    ...
                    ${!contacts.length
                        ? '<div style="color:#9ca3af;font-size:13px">No contacts available yet.</div>'
