            ...
            <aside class="p-sidebar">
                <div class="p-sidebar-card">
                    ...
                    <div class="p-identity">
                        ...
                        <div class="p-role" style="background:#fef3c7;color:#92400e;border-color:#fde68a;">System Administrator</div>
                    </div>
                    <div class="p-details">
                        <div class="p-detail">
                            <span class="p-detail-lbl">Email</span>
                            <span class="p-detail-val">${esc(user.email)}</span>
                        </div>
                        <div class="p-detail">
                            <span class="p-detail-lbl">Employee ID</span>
                            <span class="p-detail-val">${esc(user.employee_id || '—')}</span>
                        </div>
                        <div class="p-detail">
                            <span class="p-detail-lbl">Status</span>
                            <span class="p-detail-val" style="color:#15803d;text-transform:capitalize;">${esc(user.status || 'active')}</span>
                        </div>
                        <div class="p-detail">
                            <span class="p-detail-lbl">Joined</span>
                            <span class="p-detail-val">${fmtDate(user.created_at)}</span>
                        </div>
                    </div>
                </div>
            </aside>
